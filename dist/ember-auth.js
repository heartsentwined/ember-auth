...
var get$ = Ember.get;
var set$ = Ember.set;
set$(get$(get$(Em, 'Auth'), 'Module'), 'Browsersessionable', Ember.Object.extend({
  init: function () {
    null != get$(this, 'config') || set$(this, 'config', get$(get$(this, 'auth'), 'browsersessionable'));
    return this.patch();
  },
  syncEvent: function (name, args) {
    args = 2 <= arguments.length ? [].slice.call(arguments, 1) : [];
    switch (name) {
    case 'signInSuccess':
      return this.storeSessionToken();
    case 'signInError':
      return this.deleteSessionToken();
    case 'signOutSuccess':
      return this.deleteSessionToken();
    }
  },
  ...
  retrieveToken: function () {
    return get$(get$(this, 'auth'), '_session').retrieve('ember-auth-session');
  },
  storeToken: function (token) {
    return get$(get$(this, 'auth'), '_session').store('ember-auth-session', token);
  },
  removeToken: function () {
    return get$(get$(this, 'auth'), '_session').remove('ember-auth-session');
  },
  patch: function () {
    var self;
    self = this;
